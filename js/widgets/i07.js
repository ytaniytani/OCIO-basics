...
const OP_INFO = {
  ...
  alpha: {
    aim: '半とうめいの丸を、背景に重ねます。',
    param: { label: '丸のとうめい度', min: 0, max: 1, step: 0.02, value: 0.5 },
...
export default function i07(mount) {
  ...
  w.setDetails(`
    ...
    <ul>
      <li><b>正しいやりかた</b>: 0.214 + 0.214 = 0.428 の光 → 画面用の数値では 0.688</li>
